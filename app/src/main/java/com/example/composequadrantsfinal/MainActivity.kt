package com.example.composequadrantsfinal
...
import com.example.composequadrantsfinal.ui.theme.ComposequadrantsfinalTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            ComposequadrantsfinalTheme {
...
fun Test(modifier: Modifier = Modifier) {
    Column(
        ...
        Row(Modifier.background(Color.Blue)) {
            Quadrant(
                title = "Di ko magets 😭",
                content = "Bat ganerrrn parang dependent sa haba ng text",
                color = Color(0xFFEADDFF),
                modifier = Modifier.weight(1f)
            )
            Quadrant(
